...
<head>
  ...
  <link rel="icon" type="image/jpg" href="{{ asset('img/polibatam.jpg') }}">
  <title>
    Register
  </title>
  <!--     Fonts and icons     -->
...
<body class="">
  ...
  <main class="main-content  mt-0">
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('/img/curved-images/curvedneon01.jpg');">
        <span class="mask bg-gradient-dark opacity-6"></span>
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              <h1 class="text-white mb-2 mt-5">Welcome!</h1>
              <p class="text-lead text-white">Sign Up Now</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="card-body">
                <form role="form" action="{{ route('register.process') }}" method="POST"> 
                  ...
                  <div class="form-group">
                    ...
                    @enderror" id="exampleInputText" value="{{ old('nama') }}" placeholder="Nama Lengkap">
                    @error('nama')
                  ...
                  <div class="form-group">
                    ...
                    @enderror" id="exampleInputEmail" value="{{ old('email') }}" placeholder="Alamat E-Mail">
                    @error('email')
                      <small class="invalid-feedback">{{ $message }}</small>
                    @enderror
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    @enderror" id="exampleInputPassword" value="{{ old('password') }}" placeholder="Password">
                    @error('password')
                      <small class="invalid-feedback">{{ $message }}</small>
                    @enderror
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    @error('password_confirm') is-invalid 
                    @enderror" id="exampleInputPassword"value="{{ old('password_confirm') }}" placeholder="Konfirmasi Password">
